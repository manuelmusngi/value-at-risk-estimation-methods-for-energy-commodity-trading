...
│   │   │   └── [lstm_pipeline.py](https://github.com/manuelmusngi/value-at-risk-estimation-methods-for-energy-commodity-trading/blob/main/src/energy_var_backtesting/models/lstm_pipeline.py)\
│   │   ├── risk/\
...
│   │   │   ├── [var_monte_carlo.py](https://github.com/manuelmusngi/value-at-risk-estimation-methods-for-energy-commodity-trading/blob/main/src/energy_var_backtesting/risk/var_monte_carlo.py)\
│   │   │   └── [sensitivity.py](https://github.com/manuelmusngi/value-at-risk-estimation-methods-for-energy-commodity-trading/blob/main/src/energy_var_backtesting/risk/sensitivity.py)\
│   │   ├── backtesting/\
...
│   │   ├── cli/\
│   │   │   ├── [main.py](https://github.com/manuelmusngi/value-at-risk-estimation-methods-for-energy-commodity-trading/blob/main/src/energy_var_backtesting/cli/main.py)\
│   │   │   └── commands/\
│   │   │       ├── [run_lstm.py](https://github.com/manuelmusngi/value-at-risk-estimation-methods-for-energy-commodity-trading/blob/main/src/energy_var_backtesting/cli/commands/run_lstm.py)\
│   │   │       ├── [run_var.py](https://github.com/manuelmusngi/value-at-risk-estimation-methods-for-energy-commodity-trading/blob/main/src/energy_var_backtesting/cli/commands/run_var.py)\
│   │   │       ├── [run_backtest.py](https://github.com/manuelmusngi/value-at-risk-estimation-methods-for-energy-commodity-trading/blob/main/src/energy_var_backtesting/cli/commands/run_backtest.py)\
